    ...
    <Fragment>
      <div className="@container">
        <article className="mx-auto max-w-2xl space-y-2">
          ...
          <section className="hidden flex-col space-y-3 rounded-md border-2 px-5 py-2">
            ...
            <section className="mx-auto hidden flex-row justify-between space-x-6">
              <div>
                <input
                  type="radio"
                  id="model-25-flash"
                  ...
                  checked={geminiModel === "gemini-2.5-flash-preview-05-20"}
